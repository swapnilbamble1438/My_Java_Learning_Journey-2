...
public class addcustomer extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String Contact_NoD = new String(request.getParameter("Contact_No").trim());
		int Contact_No = parseInt(Contact_NoD);
	...
	private int parseInt(String contact_NoD) {
char[] c = contact_NoD.toCharArray();
