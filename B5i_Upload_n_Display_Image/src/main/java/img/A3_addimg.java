...
@MultipartConfig
@WebServlet("/A3_addimg")
public class A3_addimg extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String imageIdName = request.getParameter("imgId");
		...
		try {
			...
			String query = "insert into addimg(imgId,img) values(?,?)";
			PreparedStatement ps = con.prepareStatement(query);
			ps.setString(1, imageIdName);
